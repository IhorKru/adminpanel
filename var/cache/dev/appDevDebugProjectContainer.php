...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'gen.campaign' => 'getGen_CampaignService',
    ...
    /**
     * Gets the 'api.adk' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Services\ADKController A AppBundle\Services\ADKController instance
     */
    protected function getApi_AdkService()
    {
        $this->services['api.adk'] = $instance = new \AppBundle\Services\ADKController();
    ...
    {
        $this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('ZnvIaEdbTA', 0, (__DIR__.'/pools'));
    ...
    {
        return $this->services['cache.system'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('6XSNNUz+X6', 0, 'eKO8JqezCi1cXvCBrI7Squ', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => 3306, 'dbname' => 'mediazmj_MediaBayProd', 'user' => 'mediazmj', 'password' => '3+f9mJ5#1n0q', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_dbc2874aa70a8f7dd0ffa43f89a955425a2625dfa3acfb7a4c7b1ccadb07cf7a');
    ...
    /**
     * Gets the 'gen.campaign' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Services\CampaignController A AppBundle\Services\CampaignController instance
     */
    protected function getGen_CampaignService()
    {
        $this->services['gen.campaign'] = $instance = new \AppBundle\Services\CampaignController();
    ...
    {
        return $this->services['property_accessor'] = new \Symfony\Component\PropertyAccess\PropertyAccessor(false, false, \Symfony\Component\PropertyAccess\PropertyAccessor::createCache('N+jE-RxUj2', NULL, 'eKO8JqezCi1cXvCBrI7Squ', $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $b = ${($_ = isset($this->services['security.user.provider.concrete.user_provider']) ? $this->services['security.user.provider.concrete.user_provider'] : $this->getSecurity_User_Provider_Concrete_UserProviderService()) && false ?: '_'};
        ...
        $l->createUser(new \Symfony\Component\Security\Core\User\User('ryan', 'ryanpass', array(0 => 'ROLE_USER')));
        $l->createUser(new \Symfony\Component\Security\Core\User\User('admin', 'testadmin', array(0 => 'ROLE_ADMIN')));

        $m = new \Symfony\Component\Security\Http\HttpUtils($f, $f);

        $n = new \Symfony\Component\Security\Http\Firewall\LogoutListener($c, $m, new \Symfony\Component\Security\Http\Logout\DefaultLogoutSuccessHandler($m, '/'), array('csrf_parameter' => '_csrf_token', 'csrf_token_id' => 'logout', 'logout_path' => '/logout'));
        ...
        return $this->services['security.firewall.map.context.main'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => new \Symfony\Component\Security\Http\Firewall\ChannelListener($k, new \Symfony\Component\Security\Http\EntryPoint\RetryAuthenticationEntryPoint(80, 443), $a), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($c, array(0 => new \Symfony\Component\Security\Core\User\ChainUserProvider(array(0 => $b, 1 => $b)), 1 => $b, 2 => $l), 'main', $a, $d, $e), 2 => $n, 3 => new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($c, $h, new \Symfony\Component\Security\Http\Session\SessionAuthenticationStrategy('migrate'), $m, 'main', $o, $p, array('check_path' => 'login', 'username_parameter' => 'login[username]', 'password_parameter' => 'login[password]', 'use_forward' => false, 'require_previous_session' => true, 'csrf_parameter' => '_csrf_token', 'csrf_token_id' => 'authenticate', 'post_only' => true), $a, $d, NULL), 4 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($c, '589ad6f8782bb6.72135011', $a, $h), 5 => new \Symfony\Component\Security\Http\Firewall\AccessListener($c, ${($_ = isset($this->services['debug.security.access.decision_manager']) ? $this->services['debug.security.access.decision_manager'] : $this->getDebug_Security_Access_DecisionManagerService()) && false ?: '_'}, $k, $h)), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($c, $e, $m, 'main', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($g, $m, 'login', false), NULL, NULL, $a, false), new \Symfony\Bundle\SecurityBundle\Security\FirewallConfig('main', 'security.user_checker', 'security.request_matcher.a64d671f18e5575531d76c1d1154fdc4476cb8a79c02ed7a3469178c6d7b96b5ed4e60db', true, false, 'security.user.provider.concrete.user_provider', 'main', 'security.authentication.form_entry_point.main', NULL, NULL, array(0 => 'logout', 1 => 'form_login', 2 => 'anonymous')));
    }
    ...
    protected function getSwiftmailer_Mailer_Default_Transport_RealService()
    {
        ...
        $a->setUsername('support@jobbery.com');
        $a->setPassword('80506043850Qq');
        $a->setAuthMode(NULL);
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('26807a24a6dd52e695a7bba01f0e852941334558');
    }
    ...
    {
        return $this->services['cache.annotations'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('YMYGgmsT+2', 0, 'eKO8JqezCi1cXvCBrI7Squ', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['security.user.provider.concrete.user_provider'] = new \Symfony\Bridge\Doctrine\Security\User\EntityUserProvider($this->get('doctrine'), 'AppBundle:User', 'username', NULL);
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'database_port' => 3306,
            'database_name' => 'mediazmj_MediaBayProd',
            'database_user' => 'mediazmj',
            'database_password' => '3+f9mJ5#1n0q',
            'mailer_transport' => 'smtp',
            'mailer_host' => 'localhost',
            'mailer_user' => 'support@jobbery.com',
            'mailer_password' => '80506043850Qq',
            'secret' => '26807a24a6dd52e695a7bba01f0e852941334558',
            'locale' => 'en',
            'fragment.renderer.hinclude.global_template' => NULL,
            'fragment.path' => '/_fragment',
            'kernel.secret' => '26807a24a6dd52e695a7bba01f0e852941334558',
            ...
            'swiftmailer.mailer.default.transport.smtp.username' => 'support@jobbery.com',
            'swiftmailer.mailer.default.transport.smtp.password' => '80506043850Qq',
