    ...
    public function match($pathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/a')) {
            ...
            if ($pathinfo === '/allstats') {
                return array (  '_controller' => 'AppBundle\\Controller\\StatsController::allstatsAction',  '_route' => 'allstats',);
            }

            // annualstats
            if ($pathinfo === '/annualstats') {
                return array (  '_controller' => 'AppBundle\\Controller\\StatsController::annualstatsAction',  '_route' => 'annualstats',);
            }
        ...
        if ($pathinfo === '/monthlystats') {
            return array (  '_controller' => 'AppBundle\\Controller\\StatsController::monthlystatsAction',  '_route' => 'monthlystats',);
        }

        // weeklystats
        if ($pathinfo === '/weeklystats') {
            return array (  '_controller' => 'AppBundle\\Controller\\StatsController::weeklystatsAction',  '_route' => 'weeklystats',);
        }

        // dailystats
        if ($pathinfo === '/dailystats') {
            return array (  '_controller' => 'AppBundle\\Controller\\StatsController::dailystatsAction',  '_route' => 'dailystats',);
        }
