 ...
 */
class StatsMonthly extends \AppBundle\Entity\StatsMonthly implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\StatsMonthly' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\StatsMonthly' . "\0" . 'year', '' . "\0" . 'AppBundle\\Entity\\StatsMonthly' . "\0" . 'month', '' . "\0" . 'AppBundle\\Entity\\StatsMonthly' . "\0" . 'week', '' . "\0" . 'AppBundle\\Entity\\StatsMonthly' . "\0" . 'day', '' . "\0" . 'AppBundle\\Entity\\StatsMonthly' . "\0" . 'date', '' . "\0" . 'AppBundle\\Entity\\StatsMonthly' . "\0" . 'subscribers', '' . "\0" . 'AppBundle\\Entity\\StatsMonthly' . "\0" . 'subscribersperiod', '' . "\0" . 'AppBundle\\Entity\\StatsMonthly' . "\0" . 'unsubscribers', '' . "\0" . 'AppBundle\\Entity\\StatsMonthly' . "\0" . 'unsubscribersperiod', '' . "\0" . 'AppBundle\\Entity\\StatsMonthly' . "\0" . 'campaignssent', '' . "\0" . 'AppBundle\\Entity\\StatsMonthly' . "\0" . 'campaignsperiod', '' . "\0" . 'AppBundle\\Entity\\StatsMonthly' . "\0" . 'emailssent', '' . "\0" . 'AppBundle\\Entity\\StatsMonthly' . "\0" . 'emailssentperiod', '' . "\0" . 'AppBundle\\Entity\\StatsMonthly' . "\0" . 'revenue', '' . "\0" . 'AppBundle\\Entity\\StatsMonthly' . "\0" . 'revenueperiod', '' . "\0" . 'AppBundle\\Entity\\StatsMonthly' . "\0" . 'clicks', '' . "\0" . 'AppBundle\\Entity\\StatsMonthly' . "\0" . 'clicksperiod', '' . "\0" . 'AppBundle\\Entity\\StatsMonthly' . "\0" . 'datemodified'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (StatsMonthly $proxy) {
