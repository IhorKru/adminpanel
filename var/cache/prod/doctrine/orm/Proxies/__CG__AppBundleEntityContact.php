...
class Contact extends \AppBundle\Entity\Contact implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Contact' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Contact' . "\0" . 'name', '' . "\0" . 'AppBundle\\Entity\\Contact' . "\0" . 'emailaddress', '' . "\0" . 'AppBundle\\Entity\\Contact' . "\0" . 'subject', '' . "\0" . 'AppBundle\\Entity\\Contact' . "\0" . 'message'];
        }
