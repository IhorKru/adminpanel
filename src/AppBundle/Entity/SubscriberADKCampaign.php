...
class SubscriberADKCampaign
{
     ...
     * @var string
     *
     * @ORM\Column(name="mailingid", type="string", length=1000, nullable=true)
     */
    private $mailingid;
     ...
     * @var int
     *
     * @ORM\Column(name="scheduleeventtypeid", type="smallint", nullable=true)
     */
     ...
     * @var int
     *
     * @ORM\Column(name="list", type="smallint", nullable=true)
     */
    private $list;
     ...
     * @var int
     *
     * @ORM\Column(name="subjectid", type="smallint", nullable=true)
     */
    private $subjectid;
